...
with col3:
    #Month 
    st.markdown(f'<p style="text-align:left;color:#0d0d0c;font-family:Arial Black;font-size:30px;border-radius:0%;">Sudan</p>', unsafe_allow_html=True)
...
if submit:
	...
	#send email
        ...
        msg['From'] = fromaddr
        msg['To'] = ", ".join(toaddr)
        msg['Subject'] = "NEW Sudan CPI Data"

        body = "Kindly, find attached the recently submitted CPI Data by Sudan NSO."
